...
import 'package:drassy_api/src/api_util.dart';
...
class TransactionApi {
  ...
  Future<Response<TransactionResponse>> deleteTransactionDeleteId({ 
    ...
    final _path = r'/transaction/delete/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<BuiltList<TransactionResponse>>> getTransactionDate({ 
    ...
    final _path = r'/transaction/date';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (date != null) r'date': encodeQueryParameter(_serializers, date, const FullType(int)),
    };
  ...
  Future<Response<BuiltList<TransactionResponse>>> getTransactionPeriod({ 
    ...
    final _path = r'/transaction/period';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<TransactionResponse>>> getTransactionSearch({ 
    ...
    final _path = r'/transaction/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TransactionResponse>> postTransactionCreate({ 
    ...
    final _path = r'/transaction/create';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<String>> putTransactionUpdate({ 
    ...
    final _path = r'/transaction/update';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
