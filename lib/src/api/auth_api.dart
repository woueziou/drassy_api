...
class AuthApi {
  ...
  Future<Response<UserInfoResponse>> getAuthWhoami({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> postAuthChangepassword({ 
    NewPasswordModel? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(NewPasswordModel);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> postAuthCreateCredential({ 
    CreateCredentialsRequest? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/create_credential';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateCredentialsRequest);
      _bodyData = body == null ? null : _serializers.serialize(body, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> postAuthLogin({ 
    LoginModel? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(LoginModel);
      _bodyData = body == null ? null : _serializers.serialize(body, specifiedType: _type);
  ...
  Future<Response<String>> postAuthRegister({ 
    ...
    try {
      const _type = FullType(RegisterModel);
      _bodyData = body == null ? null : _serializers.serialize(body, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> postAuthRenew({ 
    RenewToken? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(RenewToken);
      _bodyData = body == null ? null : _serializers.serialize(body, specifiedType: _type);
